...
def home():
    return jsonify({
        ...
        "available_endpoints": [
            ...
            {
                "path": "/send-skade-data",
                "method": "GET",
                "description": "Send damage data to Rapport Service"
            },
            {
                "path": "/send-skade-data/<int:damage_niveau>",
                "method": "GET",
                "description": "Send damage data to Rapport Service with damage level"
            }
        ]
    })
